...
@MainActor
public final class ModelSelectionStore: ObservableObject {
    ...
    @Published public private(set) var active: DictationModelOption?
    ...
    public func select(_ option: DictationModelOption) {
