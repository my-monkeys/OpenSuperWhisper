...
public enum DefaultsStore {
    ...
    public static var testSuitePrefix: String {
        "\(Bundle.main.bundleIdentifier ?? "fr.my-monkey.opensuperwhisper").tests."
    }

    public static func testSuiteName(for pid: Int32) -> String { "\(testSuitePrefix)\(pid)" }
    ...
    /// read by a later run.
    public static func sweepSuitesFromPreviousRuns(keeping current: String) {
    ...
    public static func isAbandoned(_ suiteName: String) -> Bool {
